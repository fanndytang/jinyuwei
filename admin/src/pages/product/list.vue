<template>
    <el-table :data="list" border style="width: 100%">
        <el-table-column prop="title" label="产品名称" width="100"></el-table-column>
        ...
        <el-table-column prop="discount" label="产品抵扣"></el-table-column>
        <el-table-column label="操作">
            <template scope="scope">
                <router-link :to="{ path: '/home/detail', query: { id: list[scope.$index]._id }}"><span style="margin-right: 5px;">查看</span></router-link>
